<section id="dados-pagamento" class="row">
    <h2>Pagamento</h2>
    ...
    <div class="col-md-12">
        ...
        <div class="row gx-2">
            <div class="col">
                <input type="radio" class="btn-check" name="formaPagamento" id="transferencia" value="Transferência" autocomplete="off">
            ...
            <div class="col">
                <input type="radio" class="btn-check" name="formaPagamento" id="credito" value="Crédito" autocomplete="off">
                <label class="btn btn-outline-primary w-100" for="credito">
        ...
        <p class="text-muted mt-3">A seleção é apenas para informar ao Viveiro Primavera, o pagamento será feito depois.</p>                    
    </div>
</section>