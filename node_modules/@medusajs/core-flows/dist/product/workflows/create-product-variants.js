...
exports.createProductVariantsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createProductVariantsWorkflowId, (input) => {
    ...
    const variantsWithAssociatedPrices = (0, workflows_sdk_1.transform)({ input, createdVariants }, (data) => data.createdVariants
        .map((variant, i) => {
        return {
            id: variant.id,
    ...
    const variantAndPriceSets = (0, workflows_sdk_1.transform)({ variantsWithAssociatedPrices, createdPriceSets }, (data) => {
