...
function prepareListQuery(validated, queryConfig) {
    ...
    var allAllowedRelations = new Set(__spreadArray(__spreadArray([], __read(Array.from(allAllowedFields)), false), __read(allowedRelations), false));
    var notAllowedRelations = !allowedRelations.length
        ? new Set()
        : (0, utils_1.getSetDifference)(allRelations, allAllowedRelations);
