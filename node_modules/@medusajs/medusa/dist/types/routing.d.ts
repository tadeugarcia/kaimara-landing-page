...
export interface AuthenticatedMedusaRequest<Body = never> extends MedusaRequest<Body> {
    user: (User | Customer) & {
        customer_id?: string;
        userId?: string;
    };
...
export type MedusaRequestHandler = (req: MedusaRequest<unknown>, res: MedusaResponse, next: MedusaNextFunction) => Promise<void> | void;
