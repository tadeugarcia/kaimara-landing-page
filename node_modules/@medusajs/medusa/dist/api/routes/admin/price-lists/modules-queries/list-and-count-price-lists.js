...
function listAndCountPriceListPricingModule(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var remoteQuery, customerModule, query, _c, priceLists, count, customerGroupIds, customerGroups, customerGroupIdMap, _loop_1, priceLists_1, priceLists_1_1, priceList;
        var e_1, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    remoteQuery = container.resolve(modules_sdk_1.LinkModuleUtils.REMOTE_QUERY);
                    customerModule = container.resolve(modules_sdk_1.ModuleRegistrationName.CUSTOMER);
                    query = {
                ...
                case 1:
                    ...
                    customerGroupIds = priceLists
                        ...
                        .flat(2);
                    return [4 /*yield*/, customerModule.list({ id: customerGroupIds }, {})];
                case 2:
                    customerGroups = _e.sent();
                    customerGroupIdMap = new Map(customerGroups.map(function (cg) { return [cg.id, cg]; }));
                    _loop_1 = function (priceList) {
                        ...
                        var customerGroupRule = priceListRulesData.find(function (plr) { return plr.rule_type.rule_attribute === "customer_group_id"; });
                        priceList.customer_groups =
                            (customerGroupRule === null || customerGroupRule === void 0 ? void 0 : customerGroupRule.price_list_rule_values.map(function (cgr) { return customerGroupIdMap.get(cgr.value); }).filter(function (cg) { return !!cg; })) || [];
                    };
                    try {
