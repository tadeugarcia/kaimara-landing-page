...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var customerId, customerModuleService, _a, addresses, count, _b, offset, limit;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                customerId = req.auth.actor_id;
                customerModuleService = req.scope.resolve(modules_sdk_1.ModuleRegistrationName.CUSTOMER);
                return [4 /*yield*/, customerModuleService.listAndCountAddresses(__assign(__assign({}, req.filterableFields), { customer_id: customerId }), req.listConfig)];
            case 1:
                _a = __read.apply(void 0, [_c.sent(), 2]), addresses = _a[0], count = _a[1];
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var customerId, createAddresses, addresses, _a, result, errors;
