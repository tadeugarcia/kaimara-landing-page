...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, variables, query, _a, cart;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, remoteQuery(query, { cart: variables })];
            case 1:
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflow, errors, remoteQuery, query, _a, cart;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                workflow = (0, core_flows_1.updateCartWorkflow)(req.scope);
                return [4 /*yield*/, workflow.run({
                        input: __assign(__assign({}, req.validatedBody), { id: req.params.id }),
                        throwOnError: false,
                    })];
            case 1:
