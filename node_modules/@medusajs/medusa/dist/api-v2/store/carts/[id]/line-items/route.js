...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, query, _a, cart, workflowInput, errors, _b, updatedCart;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _a = __read.apply(void 0, [_c.sent(), 1]), cart = _a[0];
                workflowInput = {
                    items: [req.validatedBody],
                    cart: cart,
                };
                return [4 /*yield*/, (0, core_flows_1.addToCartWorkflow)(req.scope).run({
                        input: workflowInput,
                        throwOnError: false,
                    })];
            case 2:
            ...
            case 3:
                _b = __read.apply(void 0, [_c.sent(), 1]), updatedCart = _b[0];
