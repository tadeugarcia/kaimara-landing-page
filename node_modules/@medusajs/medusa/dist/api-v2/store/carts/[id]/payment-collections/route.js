...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflow, remoteQuery, _a, cart, errors, query;
    var _b;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                workflow = (0, core_flows_1.createPaymentCollectionForCartWorkflow)(req.scope);
            ...
            case 1:
                _a = __read.apply(void 0, [_d.sent(), 1]), cart = _a[0];
                return [4 /*yield*/, workflow.run({
                        input: {
                            cart_id: req.params.id,
                            region_id: cart.region_id,
                            currency_code: cart.currency_code,
                            amount: (_c = cart.total) !== null && _c !== void 0 ? _c : 0, // TODO: This should be calculated from the cart when totals decoration is introduced
                        },
                        throwOnError: false,
                    })];
            case 2:
                errors = (_d.sent()).errors;
