...
exports.storeRegionRoutesMiddlewares = [
    {
        ...
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.StoreGetRegionsParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.StoreRegionsRegionParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
