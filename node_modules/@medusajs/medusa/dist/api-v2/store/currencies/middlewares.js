...
exports.storeCurrencyRoutesMiddlewares = [
    {
        ...
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.StoreGetCurrenciesParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.StoreGetCurrenciesCurrencyParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
];
