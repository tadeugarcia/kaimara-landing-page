...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, context, provider_id, data, workflowInput, errors, remoteQuery, query, _b, result;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                id = req.params.id;
                _a = req.body, context = _a.context, provider_id = _a.provider_id, data = _a.data;
                // If the customer is logged in, we auto-assign them to the payment collection
                if ((_c = req.auth) === null || _c === void 0 ? void 0 : _c.actor_id) {
            ...
            case 2:
                _b = __read.apply(void 0, [_d.sent(), 1]), result = _b[0];
