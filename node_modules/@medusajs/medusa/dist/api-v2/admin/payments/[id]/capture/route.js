...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, id, errors, query, _a, payment;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.capturePaymentWorkflow)(req.scope).run({
                        input: {
                            payment_id: id,
                            captured_by: (_b = req.auth) === null || _b === void 0 ? void 0 : _b.actor_id,
            ...
            case 1:
                ...
                query = (0, utils_1.remoteQueryObjectFromString)({
                    entryPoint: "payments",
                    variables: { id: id },
                    fields: query_config_1.defaultAdminPaymentFields,
                });
                return [4 /*yield*/, remoteQuery(query)];
            case 2:
                _a = __read.apply(void 0, [_c.sent(), 1]), payment = _a[0];
