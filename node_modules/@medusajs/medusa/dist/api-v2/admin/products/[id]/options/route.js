...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, productId, queryObject, _a, product_options, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), product_options = _a.rows, metadata = _a.metadata;
                res.json({
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, input, _a, result, errors;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                productId = req.params.id;
                ...
                return [4 /*yield*/, (0, core_flows_1.createProductOptionsWorkflow)(req.scope).run({
