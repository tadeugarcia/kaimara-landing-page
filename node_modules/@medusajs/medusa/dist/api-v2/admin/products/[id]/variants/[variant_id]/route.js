...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, productId, variantId, variables, queryObject, _a, variant;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                variables = { id: variantId, product_id: productId };
            ...
            case 1:
                ...
                res.status(200).json({ variant: (0, helpers_1.remapVariant)(variant) });
                return [2 /*return*/];
        }
    });
}); };
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, variantId, _a, result, errors;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                productId = req.params.id;
                variantId = req.params.variant_id;
                return [4 /*yield*/, (0, core_flows_1.updateProductVariantsWorkflow)(req.scope).run({
                        input: {
            ...
            case 1:
                ...
                res.status(200).json({ variant: (0, helpers_1.remapVariant)(result[0]) });
                return [2 /*return*/];
        }
    });
}); };
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, variantId, errors;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                productId = req.params.id;
                variantId = req.params.variant_id;
                return [4 /*yield*/, (0, core_flows_1.deleteProductVariantsWorkflow)(req.scope).run({
