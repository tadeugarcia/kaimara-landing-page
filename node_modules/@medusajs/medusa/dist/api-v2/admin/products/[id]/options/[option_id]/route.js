...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, productId, optionId, variables, queryObject, _a, product_option;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                remoteQuery = req.scope.resolve("remoteQuery");
                productId = req.params.id;
                optionId = req.params.option_id;
                variables = { id: optionId, product_id: productId };
            ...
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 1]), product_option = _a[0];
                res.status(200).json({ product_option: product_option });
                return [2 /*return*/];
        }
    });
}); };
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, optionId, _a, result, errors;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                productId = req.params.id;
                optionId = req.params.option_id;
                return [4 /*yield*/, (0, core_flows_1.updateProductOptionsWorkflow)(req.scope).run({
                        input: {
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, optionId, errors;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                productId = req.params.id;
                optionId = req.params.option_id;
                return [4 /*yield*/, (0, core_flows_1.deleteProductOptionsWorkflow)(req.scope).run({
