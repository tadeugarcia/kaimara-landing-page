...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, result, errors;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.revokeApiKeysWorkflow)(req.scope).run({
                        input: {
                            selector: { id: req.params.id },
                            revoke: __assign(__assign({}, req.validatedBody), { revoked_by: req.auth.actor_id }),
                        },
                        throwOnError: false,
                    })];
            case 1:
