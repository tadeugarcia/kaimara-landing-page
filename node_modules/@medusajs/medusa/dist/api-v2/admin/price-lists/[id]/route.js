...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, queries_1.getPriceList)({
                        id: id,
                        container: req.scope,
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, workflow, errors, priceList;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                workflow = (0, core_flows_1.updatePriceListsWorkflow)(req.scope);
                return [4 /*yield*/, workflow.run({
                        input: { price_lists_data: [__assign({ id: id }, req.validatedBody)] },
                        throwOnError: false,
                    })];
            case 1:
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                workflow = (0, core_flows_1.deletePriceListsWorkflow)(req.scope);
                return [4 /*yield*/, workflow.run({
                        input: { ids: [id] },
                        throwOnError: false,
                    })];
