...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var moduleService, user, workflow, input, users, result, e_1;
    var _a;
        ...
        switch (_b.label) {
            case 0:
                if (req.auth.actor_id) {
                    ...
                    user = moduleService.retrieve(req.auth.actor_id);
                    res.status(200).json({ user: user });
                    return [2 /*return*/];
                }
                workflow = (0, core_flows_1.acceptInviteWorkflow)(req.scope);
                input = {
