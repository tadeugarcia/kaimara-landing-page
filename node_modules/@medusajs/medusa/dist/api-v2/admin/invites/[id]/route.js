...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, query, _a, invite;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 1]), invite = _a[0];
                if (!invite) {
                    throw new utils_1.MedusaError(utils_1.MedusaError.Types.NOT_FOUND, "Invite with id: ".concat(id, " was not found"));
                }
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                workflow = (0, core_flows_1.deleteInvitesWorkflow)(req.scope);
