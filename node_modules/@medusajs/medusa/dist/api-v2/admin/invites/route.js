...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, query, _a, invites, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), invites = _a.rows, metadata = _a.metadata;
                res.status(200).json({
                    invites: invites,
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflow, input, result, _a, invite;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                workflow = (0, core_flows_1.createInvitesWorkflow)(req.scope);
                input = {
                    input: {
                        invites: [req.validatedBody],
                    },
                };
                return [4 /*yield*/, workflow.run(input)];
            case 1:
                result = (_b.sent()).result;
                _a = __read(result, 1), invite = _a[0];
