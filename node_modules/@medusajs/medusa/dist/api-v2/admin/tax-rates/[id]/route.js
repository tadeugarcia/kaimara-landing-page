...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, remoteQuery, queryObject, _a, taxRate;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, core_flows_1.updateTaxRatesWorkflow)(req.scope).run({
                    input: {
                        selector: { id: req.params.id },
                        update: __assign(__assign({}, req.validatedBody), { updated_by: req.auth.actor_id }),
                    },
                    throwOnError: false,
                })];
            case 1:
                ...
                queryObject = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    fields: query_config_1.defaultAdminTaxRateFields,
                });
                return [4 /*yield*/, remoteQuery(queryObject)];
            case 2:
                _a = __read.apply(void 0, [_b.sent(), 1]), taxRate = _a[0];
...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, variables, queryObject, _a, taxRate;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                remoteQuery = req.scope.resolve("remoteQuery");
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.deleteTaxRatesWorkflow)(req.scope).run({
                        input: { ids: [id] },
                        throwOnError: false,
                    })];
            case 1:
