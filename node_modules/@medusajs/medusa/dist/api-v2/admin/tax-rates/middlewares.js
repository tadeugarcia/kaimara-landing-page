...
exports.adminTaxRateRoutesMiddlewares = [
    ...
    },
    {
        method: "POST",
        matcher: "/admin/tax-rates",
        middlewares: [(0, middlewares_1.transformBody)(validators_1.AdminPostTaxRatesReq)],
    },
    {
        method: "POST",
        matcher: "/admin/tax-rates/:id",
        middlewares: [(0, middlewares_1.transformBody)(validators_1.AdminPostTaxRatesTaxRateReq)],
    },
    {
        method: "GET",
        matcher: "/admin/tax-rates/:id",
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetTaxRatesTaxRateParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: "POST",
        matcher: "/admin/tax-rates/:id/rules",
        middlewares: [(0, middlewares_1.transformBody)(validators_1.AdminPostTaxRatesTaxRateRulesReq)],
    },
];
