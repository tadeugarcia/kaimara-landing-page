...
exports.adminCurrencyRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/currencies",
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetCurrenciesParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetCurrenciesCurrencyParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
];
