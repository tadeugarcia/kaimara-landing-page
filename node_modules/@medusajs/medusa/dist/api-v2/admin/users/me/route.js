...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, query, _a, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.auth.app_metadata.user_id;
            ...
            case 1:
                ...
                if (!user) {
                    throw new utils_1.MedusaError(utils_1.MedusaError.Types.NOT_FOUND, "User with id: ".concat(id, " was not found"));
                }
