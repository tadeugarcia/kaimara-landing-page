...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflowEngineService, _a, workflow_id, transaction_id, execution;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                workflowEngineService = req.scope.resolve(modules_sdk_1.ModuleRegistrationName.WORKFLOW_ENGINE);
                _a = req.params, workflow_id = _a.workflow_id, transaction_id = _a.transaction_id;
                return [4 /*yield*/, workflowEngineService.retrieveWorkflowExecution({
