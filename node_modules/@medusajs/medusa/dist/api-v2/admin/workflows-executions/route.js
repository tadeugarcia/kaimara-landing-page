...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflowEngineService, listConfig, _a, workflow_executions, count;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, workflowEngineService.listAndCountWorkflowExecution(req.filterableFields, {
            ...
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 2]), workflow_executions = _a[0], count = _a[1];
                res.json({
