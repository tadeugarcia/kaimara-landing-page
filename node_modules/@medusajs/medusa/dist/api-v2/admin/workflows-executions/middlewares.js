...
exports.adminWorkflowsExecutionsMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/workflows-executions",
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetWorkflowExecutionsParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetWorkflowExecutionDetailsParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
    ...
    },
    {
        ...
        middlewares: [(0, middlewares_1.transformBody)(validators_1.AdminPostWorkflowsRunReq)],
    },
    {
        method: ["POST"],
        matcher: "/admin/workflows-executions/:id/steps/success",
        middlewares: [(0, middlewares_1.transformBody)(validators_1.AdminPostWorkflowsAsyncResponseReq)],
    },
    {
        method: ["POST"],
