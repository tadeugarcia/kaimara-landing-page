...
export declare class AdminPostPromotionsPromotionRulesBatchAddReq {
    rules: PromotionRule[];
}
export declare class AdminPostPromotionsPromotionRulesBatchRemoveReq {
    rule_ids: string[];
}
export declare class AdminPostPromotionsPromotionRulesBatchUpdateReq {
    rules: UpdatePromotionRule[];
}
export declare class UpdatePromotionRule {
    id: string;
    operator?: PromotionRuleOperator;
    description?: string | null;
    attribute: string;
