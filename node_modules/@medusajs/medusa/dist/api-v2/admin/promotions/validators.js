...
exports.UpdatePromotionRule = exports.AdminPostPromotionsPromotionRulesBatchUpdateReq = exports.AdminPostPromotionsPromotionRulesBatchRemoveReq = exports.AdminPostPromotionsPromotionRulesBatchAddReq = exports.AdminPostPromotionsPromotionReq = exports.ApplicationMethodsMethodPostReq = exports.ApplicationMethodsPostReq = exports.PromotionRule = exports.AdminPostPromotionsReq = exports.AdminGetPromotionsParams = exports.AdminGetPromotionsPromotionParams = void 0;
...
var AdminPostPromotionsPromotionRulesBatchAddReq = /** @class */ (function () {
    function AdminPostPromotionsPromotionRulesBatchAddReq() {
    }
    __decorate([
        (0, class_validator_1.IsArray)(),
        (0, class_validator_1.ValidateNested)({ each: true }),
        (0, class_transformer_1.Type)(function () { return PromotionRule; }),
        __metadata("design:type", Array)
    ], AdminPostPromotionsPromotionRulesBatchAddReq.prototype, "rules", void 0);
    return AdminPostPromotionsPromotionRulesBatchAddReq;
}());
exports.AdminPostPromotionsPromotionRulesBatchAddReq = AdminPostPromotionsPromotionRulesBatchAddReq;
var AdminPostPromotionsPromotionRulesBatchRemoveReq = /** @class */ (function () {
    function AdminPostPromotionsPromotionRulesBatchRemoveReq() {
    }
    __decorate([
        (0, class_validator_1.ArrayNotEmpty)(),
        (0, class_validator_1.IsString)({ each: true }),
        __metadata("design:type", Array)
    ], AdminPostPromotionsPromotionRulesBatchRemoveReq.prototype, "rule_ids", void 0);
    return AdminPostPromotionsPromotionRulesBatchRemoveReq;
}());
exports.AdminPostPromotionsPromotionRulesBatchRemoveReq = AdminPostPromotionsPromotionRulesBatchRemoveReq;
var AdminPostPromotionsPromotionRulesBatchUpdateReq = /** @class */ (function () {
    function AdminPostPromotionsPromotionRulesBatchUpdateReq() {
    }
    __decorate([
        (0, class_validator_1.IsArray)(),
        (0, class_validator_1.ValidateNested)({ each: true }),
        (0, class_transformer_1.Type)(function () { return UpdatePromotionRule; }),
        __metadata("design:type", Array)
    ], AdminPostPromotionsPromotionRulesBatchUpdateReq.prototype, "rules", void 0);
    return AdminPostPromotionsPromotionRulesBatchUpdateReq;
}());
exports.AdminPostPromotionsPromotionRulesBatchUpdateReq = AdminPostPromotionsPromotionRulesBatchUpdateReq;
var UpdatePromotionRule = /** @class */ (function () {
    ...
    __decorate([
        ...
        (0, class_validator_1.IsString)(),
        __metadata("design:type", String)
    ], UpdatePromotionRule.prototype, "id", void 0);
    __decorate([
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.IsEnum)(utils_1.PromotionRuleOperator),
        __metadata("design:type", String)
    ], UpdatePromotionRule.prototype, "operator", void 0);
    __decorate([
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.IsString)(),
        __metadata("design:type", Object)
    ], UpdatePromotionRule.prototype, "description", void 0);
    __decorate([
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.IsNotEmpty)(),
        (0, class_validator_1.IsString)(),
        __metadata("design:type", String)
    ], UpdatePromotionRule.prototype, "attribute", void 0);
    __decorate([
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.IsArray)(),
        (0, class_transformer_1.Type)(function () { return String; }),
        __metadata("design:type", Array)
    ], UpdatePromotionRule.prototype, "values", void 0);
    return UpdatePromotionRule;
}());
exports.UpdatePromotionRule = UpdatePromotionRule;
