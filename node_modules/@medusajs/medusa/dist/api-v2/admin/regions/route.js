...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, regions, metadata;
        ...
        switch (_b.label) {
            case 0:
                ...
                queryObject = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    fields: query_config_1.defaultAdminRegionFields,
                });
                return [4 /*yield*/, remoteQuery(queryObject)];
            case 1:
                _a = _b.sent(), regions = _a.rows, metadata = _a.metadata;
                res.json({
                    regions: regions,
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, core_flows_1.createRegionsWorkflow)(req.scope).run({
