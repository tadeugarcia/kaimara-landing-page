...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, result, errors, remoteQuery, query, _b, taxRegion;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, (0, core_flows_1.createTaxRegionsWorkflow)(req.scope).run({
                    input: [
            ...
            case 1:
                ...
                query = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    fields: query_config_1.defaultAdminTaxRegionFields,
                });
                return [4 /*yield*/, remoteQuery(query)];
            case 2:
                _b = __read.apply(void 0, [_c.sent(), 1]), taxRegion = _b[0];
