...
exports.adminTaxRegionRoutesMiddlewares = [
    ...
    },
    {
        method: "POST",
        matcher: "/admin/tax-regions",
        middlewares: [(0, middlewares_1.transformBody)(validators_1.AdminPostTaxRegionsReq)],
    },
    {
        method: "GET",
        matcher: "/admin/tax-regions",
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetTaxRegionsParams, QueryConfig.listTransformQueryConfig),
        ],
    },
];
