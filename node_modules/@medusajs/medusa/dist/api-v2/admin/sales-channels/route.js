...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, variables, queryObject, _a, sales_channels, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), sales_channels = _a.rows, metadata = _a.metadata;
                res.json({
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var salesChannelsData, errors, remoteQuery, queryObject, _a, sales_channel;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                salesChannelsData = [req.validatedBody];
                return [4 /*yield*/, (0, core_flows_1.createSalesChannelsWorkflow)(req.scope).run({
                        input: { salesChannelsData: salesChannelsData },
                        throwOnError: false,
                    })];
            case 1:
