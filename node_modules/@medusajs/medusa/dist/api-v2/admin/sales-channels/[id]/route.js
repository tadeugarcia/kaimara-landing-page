...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, variables, queryObject, _a, sales_channel;
        ...
        switch (_b.label) {
            case 0:
                ...
                queryObject = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    variables: variables,
                    fields: query_config_1.defaultAdminSalesChannelFields,
                });
                return [4 /*yield*/, remoteQuery(queryObject)];
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 1]), sales_channel = _a[0];
                res.json({ sales_channel: sales_channel });
                return [2 /*return*/];
        }
    });
}); };
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, remoteQuery, queryObject, _a, sales_channel;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, core_flows_1.updateSalesChannelsWorkflow)(req.scope).run({
                    input: {
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.deleteSalesChannelsWorkflow)(req.scope).run({
                        input: { ids: [id] },
                        throwOnError: false,
                    })];
            case 1:
