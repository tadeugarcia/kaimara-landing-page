...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, query, rows, _a, inventory_item;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                rows = (_b.sent()).rows;
                _a = __read(rows, 1), inventory_item = _a[0];
                if (!inventory_item) {
                    throw new utils_1.MedusaError(utils_1.MedusaError.Types.NOT_FOUND, "Inventory item with id: ".concat(id, " was not found"));
                }
                res.status(200).json({
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, deleteInventoryItems, errors;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                deleteInventoryItems = (0, core_flows_1.deleteInventoryItemWorkflow)(req.scope);
                return [4 /*yield*/, deleteInventoryItems.run({
                        input: [id],
                        throwOnError: false,
                    })];
            case 1:
