...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, result, _a, inventory_item;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
                return [4 /*yield*/, (0, core_flows_1.createInventoryItemsWorkflow)(req.scope).run({
            ...
            case 2:
                _a = __read.apply(void 0, [_b.sent(), 1]), inventory_item = _a[0];
                res.status(200).json({ inventory_item: inventory_item });
                return [2 /*return*/];
        }
    });
}); };
...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, query, _a, inventory_items, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
                query = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    fields: __spreadArray([], __read(req.listConfig.select), false),
                });
                return [4 /*yield*/, remoteQuery(__assign({}, query))];
            case 1:
                _a = _b.sent(), inventory_items = _a.rows, metadata = _a.metadata;
                res.status(200).json({
