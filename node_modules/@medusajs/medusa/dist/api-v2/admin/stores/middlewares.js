...
exports.adminStoreRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/stores",
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetStoresParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetStoresStoreParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/stores/:id",
        middlewares: [(0, middlewares_1.transformBody)(validators_1.AdminPostStoresStoreReq)],
    },
];
