...
exports.adminCollectionRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/collections",
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetCollectionsParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetCollectionsCollectionParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/collections",
        middlewares: [(0, middlewares_1.transformBody)(validators_1.AdminPostCollectionsReq)],
    },
    {
        method: ["POST"],
        matcher: "/admin/collections/:id",
        middlewares: [(0, middlewares_1.transformBody)(validators_1.AdminPostCollectionsCollectionReq)],
    },
    {
        method: ["DELETE"],
        matcher: "/admin/collections/:id",
