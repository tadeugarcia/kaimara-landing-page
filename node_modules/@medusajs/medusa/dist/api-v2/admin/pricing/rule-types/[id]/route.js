...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var pricingModule, ruleType;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pricingModule = req.scope.resolve(modules_sdk_1.ModuleRegistrationName.PRICING);
                return [4 /*yield*/, pricingModule.retrieveRuleType(req.params.id, {
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflow, _a, result, errors;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                workflow = (0, core_flows_1.updatePricingRuleTypesWorkflow)(req.scope);
                return [4 /*yield*/, workflow.run({
                        input: {
                            data: [__assign(__assign({}, req.validatedBody), { id: req.params.id })],
                        },
                        throwOnError: false,
                    })];
            case 1:
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, workflow, errors;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                workflow = (0, core_flows_1.deletePricingRuleTypesWorkflow)(req.scope);
                return [4 /*yield*/, workflow.run({
                        input: { ids: [id] },
                        throwOnError: false,
                    })];
