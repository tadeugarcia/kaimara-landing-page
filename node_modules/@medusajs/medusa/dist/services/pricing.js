...
var PricingService = /** @class */ (function (_super) {
    ...
    PricingService.prototype.getProductVariantPricingModulePricing_ = function (variantPriceData, context) {
        return __awaiter(this, void 0, void 0, function () {
            var variables, query, variantPriceSets, variantIdToPriceSetIdMap, priceSetIds, queryContext, groups, calculatedPrices, calculatedPriceMap, pricingResultMap;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        variables = {
                            variant_id: variantPriceData.map(function (pricedata) { return pricedata.variantId; }),
                            take: null,
                        };
                        query = {
                        ...
                        return [4 /*yield*/, this.remoteQuery(query)];
                    case 1:
                        variantPriceSets = _a.sent();
                        variantIdToPriceSetIdMap = new Map(variantPriceSets.map(function (variantPriceSet) { return [
                            variantPriceSet.variant_id,
                            variantPriceSet.price_set_id,
                        ]; }));
                        priceSetIds = variantPriceSets.map(function (variantPriceSet) { return variantPriceSet.price_set_id; });
                        queryContext = (0, utils_1.removeNullish)(context.price_selection);
                        if (!queryContext.customer_id) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.customerService_.retrieve(queryContext.customer_id, { relations: ["groups"] })];
                    case 2:
                        groups = (_a.sent()).groups;
                        if (groups === null || groups === void 0 ? void 0 : groups.length) {
                            queryContext.customer_group_id = groups.map(function (group) { return group.id; });
                        }
                        _a.label = 3;
                    case 3:
                        calculatedPrices = [];
                        if (!queryContext.currency_code) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.pricingModuleService.calculatePrices({ id: priceSetIds }, {
                                context: queryContext,
                            })];
                    case 4:
                        calculatedPrices = (_a.sent());
                        _a.label = 5;
                    case 5:
                        calculatedPriceMap = new Map(calculatedPrices.map(function (priceSet) { return [priceSet.id, priceSet]; }));
                        pricingResultMap = new Map();
                        variantPriceData.forEach(function (_a) {
                            var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
                            var variantId = _a.variantId;
                            var priceSetId = variantIdToPriceSetIdMap.get(variantId);
                            var pricingResult = {
                                prices: [],
                                original_price: null,
                            ...
                            if (priceSetId) {
                                var calculatedPrices_1 = calculatedPriceMap.get(priceSetId);
                                if (calculatedPrices_1) {
                                    pricingResult.prices.push({
                                        id: (_b = calculatedPrices_1 === null || calculatedPrices_1 === void 0 ? void 0 : calculatedPrices_1.original_price) === null || _b === void 0 ? void 0 : _b.money_amount_id,
                                        currency_code: calculatedPrices_1.currency_code,
                                        amount: calculatedPrices_1.original_amount,
                                        min_quantity: (_c = calculatedPrices_1.original_price) === null || _c === void 0 ? void 0 : _c.min_quantity,
                                        max_quantity: (_d = calculatedPrices_1.original_price) === null || _d === void 0 ? void 0 : _d.max_quantity,
                                        price_list_id: (_e = calculatedPrices_1.original_price) === null || _e === void 0 ? void 0 : _e.price_list_id,
                                    });
                                    if (((_f = calculatedPrices_1.calculated_price) === null || _f === void 0 ? void 0 : _f.money_amount_id) !==
                                        ((_g = calculatedPrices_1.original_price) === null || _g === void 0 ? void 0 : _g.money_amount_id)) {
                                        pricingResult.prices.push({
                                            id: (_h = calculatedPrices_1.calculated_price) === null || _h === void 0 ? void 0 : _h.money_amount_id,
                                            currency_code: calculatedPrices_1.currency_code,
                                            amount: calculatedPrices_1.calculated_amount,
                                            min_quantity: (_j = calculatedPrices_1.calculated_price) === null || _j === void 0 ? void 0 : _j.min_quantity,
                                            max_quantity: (_k = calculatedPrices_1.calculated_price) === null || _k === void 0 ? void 0 : _k.max_quantity,
                                            price_list_id: (_l = calculatedPrices_1.calculated_price) === null || _l === void 0 ? void 0 : _l.price_list_id,
                                        });
                                    }
                                    pricingResult.original_price = calculatedPrices_1 === null || calculatedPrices_1 === void 0 ? void 0 : calculatedPrices_1.original_amount;
                                    pricingResult.calculated_price = calculatedPrices_1 === null || calculatedPrices_1 === void 0 ? void 0 : calculatedPrices_1.calculated_amount;
                                    pricingResult.calculated_price_type =
                                        (_m = calculatedPrices_1 === null || calculatedPrices_1 === void 0 ? void 0 : calculatedPrices_1.calculated_price) === null || _m === void 0 ? void 0 : _m.price_list_type;
                                }
                            }
    ...
    PricingService.prototype.getProductVariantPricing_ = function (data, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (!this.featureFlagRouter.isFeatureEnabled(utils_1.MedusaV2Flag.key)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.getProductVariantPricingModulePricing_(data, context)];
                    case 1: return [2 /*return*/, _e.sent()];
                    case 2: return [4 /*yield*/, this.priceSelectionStrategy
                            .withTransaction(this.activeManager_)
    ...
    PricingService.prototype.getPricingModuleVariantMoneyAmounts = function (variantIds) {
        return __awaiter(this, void 0, void 0, function () {
            var variables, query, variantPriceSets, priceSetIdToVariantIdMap, priceSetIds, priceSetMoneyAmounts, variantIdMoneyAmountMap;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        variables = {
                    ...
                    case 1:
                        variantPriceSets = _a.sent();
                        priceSetIdToVariantIdMap = new Map(variantPriceSets.map(function (variantPriceSet) { return [
                            variantPriceSet.price_set_id,
                            variantPriceSet.variant_id,
                        ]; }));
                        priceSetIds = variantPriceSets.map(function (variantPriceSet) { return variantPriceSet.price_set_id; });
                        return [4 /*yield*/, this.pricingModuleService.listPriceSetMoneyAmounts({
                    ...
                    case 2:
                        priceSetMoneyAmounts = _a.sent();
                        variantIdMoneyAmountMap = priceSetMoneyAmounts.reduce(function (map, priceSetMoneyAmount) {
                            var _a, _b, _c, _d, _e;
                            var variantId = priceSetIdToVariantIdMap.get(priceSetMoneyAmount.price_set.id);
                            if (!variantId) {
                                return map;
                            }
                            var regionId = (_a = priceSetMoneyAmount.price_rules.find(function (pr) { return pr.rule_type.rule_attribute === "region_id"; })) === null || _a === void 0 ? void 0 : _a.value;
                            (_b = priceSetMoneyAmount.money_amount) === null || _b === void 0 ? true : delete _b.price_set_money_amount;
                            var moneyAmount = __assign(__assign({}, priceSetMoneyAmount.money_amount), { region_id: null, price_list_id: (_d = (_c = priceSetMoneyAmount.price_list) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : null, price_list: (_e = priceSetMoneyAmount.price_list) !== null && _e !== void 0 ? _e : null });
                            if (regionId) {
                        ...
                        return [2 /*return*/, variantIdMoneyAmountMap];
                }
            });
        });
    };
    PricingService.prototype.setAdminVariantPricing = function (variants, context) {
        if (context === void 0) { context = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var variantIds, variantIdMoneyAmountMap;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.featureFlagRouter.isFeatureEnabled(utils_1.MedusaV2Flag.key)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.setVariantPrices(variants, context)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        variantIds = variants.map(function (variant) { return variant.id; });
                        return [4 /*yield*/, this.getPricingModuleVariantMoneyAmounts(variantIds)];
                    case 3:
                        variantIdMoneyAmountMap = _a.sent();
                        return [2 /*return*/, variants.map(function (variant) {
                                var _a;
                                var pricing = {
                                    prices: (_a = variantIdMoneyAmountMap.get(variant.id)) !== null && _a !== void 0 ? _a : [],
                                    original_price: null,
                                    calculated_price: null,
                                    calculated_price_type: null,
                                    original_price_includes_tax: null,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.featureFlagRouter.isFeatureEnabled(utils_1.MedusaV2Flag.key)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.setProductPrices(products)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        variantIds = products
                            .map(function (product) { return product.variants.map(function (variant) { return variant.id; }).flat(); })
                            .flat();
                        return [4 /*yield*/, this.getPricingModuleVariantMoneyAmounts(variantIds)];
                    case 3:
                        variantIdMoneyAmountMap = _a.sent();
                        return [2 /*return*/, products.map(function (product) {
                                ...
                                product.variants.map(function (productVariant) {
                                    var _a;
                                    var pricing = {
                                        prices: (_a = variantIdMoneyAmountMap.get(productVariant.id)) !== null && _a !== void 0 ? _a : [],
                                        original_price: null,
                                        calculated_price: null,
                                        calculated_price_type: null,
                                        original_price_includes_tax: null,
