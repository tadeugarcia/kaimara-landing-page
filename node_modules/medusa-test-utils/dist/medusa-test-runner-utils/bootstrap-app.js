...
var isObject = require("@medusajs/utils").isObject;
function bootstrapApp(_a) {
    var _b = _a === void 0 ? {} : _a, cwd = _b.cwd, _c = _b.env, env = _c === void 0 ? {} : _c;
    return __awaiter(this, void 0, void 0, function () {
        var app, loaders, _d, container, dbConnection, pgConnection, disposeResources, PORT;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    _d = _e.sent(), container = _d.container, dbConnection = _d.dbConnection, pgConnection = _d.pgConnection, disposeResources = _d.disposeResources;
...
module.exports = {
    startBootstrapApp: function (_a) {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            var _e, app, port, container, db, pgConnection, expressServer, shutdown;
            var _this = this;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        _e = _f.sent(), app = _e.app, port = _e.port, container = _e.container, db = _e.db, pgConnection = _e.pgConnection;
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, Promise.all([
                                            container.dispose(),
                                            expressServer.close(),
                                            db === null || db === void 0 ? void 0 : db.destroy(),
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                expressServer = app.listen(port, function (err) { return __awaiter(_this, void 0, void 0, function () {
