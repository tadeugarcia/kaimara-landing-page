...
var migrateMedusaApp = require("@medusajs/medusa/dist/loaders/medusa-app").migrateMedusaApp;
var logger = require("@medusajs/medusa-cli/dist/reporter").logger;
module.exports = {
    initDb: function (_a) {
        var cwd = _a.cwd, database_extra = _a.database_extra, env = _a.env, force_modules_migration = _a.force_modules_migration, _b = _a.dbUrl, dbUrl = _b === void 0 ? DB_URL : _b, _c = _a.dbSchema, dbSchema = _c === void 0 ? "public" : _c;
        return __awaiter(this, void 0, void 0, function () {
            var configModule, featureFlagsLoader, featureFlagRouter, modelsLoader, entities, migrationDir, _d, getEnabledMigrations, getModuleSharedResources, _e, moduleMigrations, moduleModels, enabledMigrations, enabledEntities, dbDataSource, pgConnectionLoader, featureFlagLoader, container, featureFlagRouter_1, pgConnection;
            var _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        configModule = getConfigFile(cwd, "medusa-config").configModule;
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, pgConnectionLoader({ configModule: configModule, container: container })];
                    case 4:
